...
import { Sun, Moon, ShieldCheck, MessageCircle, MapPin, Truck, Tractor } from 'lucide-react'
import { useTheme } from '../hooks/useTheme'
import { useLanguage } from '../hooks/useLanguage'
import AgriPoolLogo from '../components/ui/AgriPoolLogo'
    ...
    >
      ...
      >
        ...
        <Link to="/" className="relative z-10 flex items-center gap-3 font-bold text-2xl group">
          <AgriPoolLogo className="w-10 h-10 group-hover:scale-105 transition-transform duration-300 shadow-[0_0_20px_rgba(16,185,129,0.3)]" iconSizeMultiplier={1.1} />
