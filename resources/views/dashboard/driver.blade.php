    ...
    <body>
        <header class="nav">
            <div class="container nav-inner">
                <a class="brand" href="/dashboard"><span class="brand-mark"></span><span>AgriPool Driver</span></a>
        ...
        <main class="container">
            <section class="hero">
                <h1>Driver panel with the same old AgriPool UX.</h1>
                <p class="lead">Accept assigned trips, keep milestone updates simple, and finish deliveries with clear completion status.</p>
            </section>
            <section class="grid">
                <article class="card">
                    <h2>Assigned deliveries</h2>
                    <div class="list">
                        <div class="row"><span>Wheat load - Bhopal route</span><small>Pickup 10:30</small></div>
                        <div class="row"><span>Rice transport - Sehore</span><small>Drop 13:10</small></div>
                        <div class="row"><span>Equipment move - Vidisha</span><small>Ready</small></div>
                    </div>
                </article>
                <article class="card">
                    <h2>Quick actions</h2>
                    <div class="list">
                        <div class="row"><span>Start pickup</span><small>Now</small></div>
                        <div class="row"><span>Update live location</span><small>Online</small></div>
                        <div class="row"><span>Mark trip completed</span><small>Verify</small></div>
                    </div>
                </article>
            </section>
        </main>
