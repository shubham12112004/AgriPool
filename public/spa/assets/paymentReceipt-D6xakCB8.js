import{z as a}from"./index-DcziuSX2.js";function n(t){t&&sessionStorage.setItem("agripool_last_payment",JSON.stringify(t))}function c(){try{const t=sessionStorage.getItem("agripool_last_payment");return t?JSON.parse(t):null}catch{return null}}function l(t,e="Customer"){const o=t.is_demo?"DEMO":"PAID";return`<!DOCTYPE html>
